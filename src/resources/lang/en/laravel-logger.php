...
return [
    ...
    */
    'dashboard' => [
        ...
        'menu'      => [
            ...
            'clear'         => 'Clear VisitorActivity Log',
            'show'          => 'Show Cleared Logs',
            'back'          => 'Back to VisitorActivity Log',
        ],
    ],
    ...
    */
    ...
    'drilldown' => [
        ...
        'title-user-activity'   => 'Additional User VisitorActivity',
    ...
    */
    ...
    'dashboardCleared' => [
        'title'     => 'Cleared VisitorActivity Logs',
        'subtitle'  => 'Cleared Events',

        'menu'      => [
            'deleteAll'  => 'Delete All VisitorActivity Logs',
            'restoreAll' => 'Restore All VisitorActivity Logs',
        ],
    ],
